...
# QSelectiveSSM: nn.linear -> QLinear, ssm -> QSelectiveSSM
def _ssm(
...
# QBlock: nn.linear -> QLinear, block -> QBlock, ssm -> QSelectiveSSM, conv1d -> QConv1d
def _block(
...
# nn.linear -> QLinear, block -> QBlock, ssm -> QSelectiveSSM
def prepare_components(
    ...
    # replace block -> QBlock (mamba/q_block.py)
